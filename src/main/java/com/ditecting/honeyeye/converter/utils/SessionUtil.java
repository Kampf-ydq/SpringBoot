...
public class SessionUtil {
    ...
    public static PacketSession generatePacketSession (FullPacket fp, double timeout) {
        ...
        PacketSession packetSession = PacketSession.builder()
                .signature(signature)
                .timeout(timeout)
        ...
        packetSession.addSegment(PacketUtil.packetToSegment(fp));
    ...
    public static void extendPacketSession(@NonNull PacketSession ps, FullPacket fp){
        ...
        ps.addSegment(PacketUtil.packetToSegment(fp));
        ps.setEndTime(fp.getPcapDataHeader().getTime());
    }
}