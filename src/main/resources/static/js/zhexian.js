...
$(function () {
    ...
    var data1 = [
        [123,194, 234, 321,321, 118, 240, 434, 278, 110, 534, 154, 23, 354, 334, 221, 178, 190, 234,234, 321, 120, 390, 634],
        [63,434, 278, 110, 534, 154, 23, 354, 334, 221, 178, 190, 234,234, 321, 120, 390, 634, 194, 234, 321, 278, 110, 534],
        [53, 254, 234, 321, 118, 240, 434,194, 234, 321,321, 118, 240, 434, 278, 110, 534, 154, 23, 354, 334, 221, 178, 190],

    ]
    var Line = ["04-11", "04-12", "04-13"];
    var img = [
    ...
    var color = ['#dcf776', '#f1c31a', '#0696f9'];
...
//当点击legend选项时折线上的小图片会消失，为避免这种情况，可以采取以下初始化方法 使用svg
    var myCharts = echarts.init(document.getElementById('left_2'), null, {renderer: 'svg'});
    myCharts.clear();
    myCharts.setOption(optionZhexian)
})