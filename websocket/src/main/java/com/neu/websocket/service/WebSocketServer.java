package com.neu.websocket.service;
...
public class WebSocketServer {
    ...
    public void onOpen(Session session) {
        ...
        //获取日志信息
        new Thread(() -> {
            log.info("LoggingWebSocketServer 服务启动");
            boolean first = true;
            while (sessionMap.get(session.getId()) != null) {
                BufferedReader reader = null;
                try {
                    //日志文件路径，获取最新的
                    String filePath = "G:\\Cybersecurity\\workSpace\\Jetbrains\\websocket\\honeyeye.log";
            ...
            log.info("LoggingWebSocketServer 服务结束");
        }).start();
    }
